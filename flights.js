// ============================================================
//  flights.js v2 — Полная система авиабилетов
...
function registerFlightCommands(bot) {
  ...
  if (CHAT_ID) {
    ...
    console.log('[FlyBot] ✈️ Мониторинг цен запланирован: 00:00, 06:00, 12:00, 18:00 (МСК)');
  }

  console.log('[FlyBot] ✈️ Модуль авиабилетов v2 подключён — /fly для меню');
}
